...
docker run -d -v /root/.docker:/root/.docker -p 2376:2375 swarm manage --tlsverify --tlscacert=/.docker/ca.pem --tlskey=/.docker/key.pem --tlscert=/.docker/cert.pem token://$swarm_cluster_id
