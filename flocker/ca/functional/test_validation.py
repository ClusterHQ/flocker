...
from twisted.internet.defer import Deferred, gatherResults, fail
    ...
    def assert_requests_validates(self, hostname, cert_name):
        ...
        def req():
            try:
                ...
                reactor.callFromThread(request_result.errback, fail())
            else:
                reactor.callFromThread(request_result.callback, result)
        Thread(target=req).start()
        d.addCallback(lambda _: request_result)
