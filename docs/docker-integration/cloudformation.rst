...
.. raw:: html
	...
	<div class="step-stages step-stages--3up">
		...
		<div class="step-stages__step">
            ...
            <span>Click "Create Key Pair". Give your key pair a meaningful name, like <strong>username-flocker-test</strong>. You'll need this later, so <strong>make a note of it</strong>.</span>
		</div>
		<div class="step-stages__step">
	...
	<div class="step-stages step-stages--3up">
		<div class="step-stages__excerpt">
            ...
            <div style="text-align:left;">
                ...
                <p>Where a command has <code>&lt;KeyPath&gt;</code> use the path on your machine to the <code>.pem</code> file you downloaded in Step 1, for example: <code>~/Downloads/username-flocker-test.pem</code>.</p>
