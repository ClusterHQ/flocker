...
===================================
Using the Flocker Plugin for Docker
===================================
...
Once :ref:`installed <install-docker-plugin>` it can be invoked by Docker using the :ref:`docker-plugin-cli` or :ref:`docker-plugin-api`.
