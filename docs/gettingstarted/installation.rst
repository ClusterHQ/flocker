...
.. note:: If you are not familiar with EC2 you may want to `read more about the terminology and concepts <http://fedoraproject.org/wiki/User:Gholms/EC2_Primer>`_ used in this document.
