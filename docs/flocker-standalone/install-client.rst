.. _installing-flocker-cli-standalone-flocker:
...
.. _installing-flocker-cli-ubuntu-14.04-standalone-flocker:
...
.. _installing-client-OSX-standalone-flocker:

.. include:: ../installation/install-client.rst
   :start-after: .. begin-body-installing-client-OSX
   :end-before: .. end-body-installing-client-OSX

.. _postinstall-nextstep-standalone-flocker:

Next Step
=========

The next section describes your next step - :ref:`Installing the Flocker Node Services<installing-flocker-node-standalone-flocker>`.
