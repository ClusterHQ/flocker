...
Flocker also has planned integrations with major orchestration tools such as Docker Swarm, Kubernetes and Apache Mesos. More information on this integration is :ref:`available in the Labs section <labs-projects>`.
