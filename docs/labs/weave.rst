...
So you can simply install the :ref:`Flocker Docker plugin <labs-docker-plugin>` and install the `Weave Docker plugin <http://weave.works/docker-plugins>` and it should Just Work.
