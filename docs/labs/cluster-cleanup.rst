...
If you have completed the steps in our :ref:`short tutorial <short-tutorial>`, you can run the following steps to clean up your volumes, your instances and your local files:
